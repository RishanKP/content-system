...
import (
	...
	_ "content-system/users/cmd/app/docs"
	"content-system/users/pkg/models/db"
...
func main() {
	...
	serverPort := flag.Int("serverPort", 8000, "server network port")
	...
	app := &Application{
		...
		ErrorLog: errorLog,
		Users: &db.UserModel{
			Client: client.Database(*mongoDatabase).Collection("users"),
		},
	}
