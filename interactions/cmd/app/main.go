...
import (
	...
	_ "content-system/interactions/cmd/app/docs"
	"content-system/interactions/pkg/models/db"
...
type Application struct {
	ErrorLog     *log.Logger
	InfoLog      *log.Logger
	Interactions *db.InteractionsModel
}
...
func main() {
	...
	serverPort := flag.Int("serverPort", 8002, "server network port")
	...
	app := &Application{
		...
		ErrorLog: errorLog,
		Interactions: &db.InteractionsModel{
			Client: client.Database(*mongoDatabase).Collection("interactions"),
		},
	}
